...
(function(c) {
    c.widget("metro.accordion", {
        ...
        init: function() {
            var a = this;
            a.element.on("click", ".accordion-frame > .heading", function(b) {
                b.preventDefault();
                b.stopPropagation();
                if (!c(this).attr("disabled") && "none" != c(this).data("action")) {
                    a.options.closeAny && a._closeFrames();
                    var d = c(this).parent(),
                        e = d.children(".content");
                    console.log(this);
                    c(e).is(":hidden") ? (c(e).slideDown(), c(this).removeClass("collapsed"), a._trigger("frame", b, {
                        frame: d
                    }), a.options.open(d)) : (c(e).slideUp(), c(this).addClass("collapsed"));
                    a.options.action(d)
                }
            });
            this.element.children(".accordion-frame").each(function() {
                var a = c(this).children(".heading"),
                    d = c(this).children(".content");
                c(this).hasClass("active") && !c(this).attr("disabled") && "none" != c(this).data("action") ? (c(d).show(), c(a).removeClass("collapsed")) : c(a).addClass("collapsed")
            })
        },
        _closeFrames: function() {
            var a = this.element.children(".accordion-frame");
            c.each(a, function() {
                var a = c(this);
                a.children(".heading").addClass("collapsed");
    ...
    c.widget("metro.datepicker", {
        ...
        _create: function() {
            ...
            e.on("click", function(b) {
                b.stopPropagation();
                "none" == a.options._calendar.css("display") ?
                    a._show() : a._hide()
            });
    ...
    c.widget("metro.slider", {
        ...
        _create: function() {
            ...
            void 0 != b.data("animate") &&
                (d.animate = b.data("animate"));
            void 0 != b.data("min") && (d.min = b.data("min"));
            d.min = 0 > d.min ? 0 : d.min;
            d.min = d.min > d.max ? d.max : d.min;
            void 0 != b.data("max") && (d.max = b.data("max"));
            d.max = 100 < d.max ? 100 : d.max;
            d.max = d.max < d.min ? d.min : d.max;
            void 0 != b.data("position") && (d.position = this._correctValue(b.data("position") > this.options.min ? b.data("position") > this.options.max ? this.options.max : b.data("position") : this.options.min));
        ...
        _placeMarker: function(a) {
            ...
            d = this._percToPix(this.options.position);
            f = c.colors.length;
            ...
            if (this.options._slider.vertical) {
                ...
                d = this.options._slider.length - b;
                ...
                f && (f = Math.round(b / g) - 1, k.css("background-color", c.colors[0 > f ? 0 : f]));
                c.showHint && l.html(Math.round(a)).css("top", d - l.height() /
                    2)
            } else b = this._percToPix(a), this._animate(h.css("left", d), {
                left: b
            }), this._animate(k.css("width", d), {
                width: b
            }), f && (f = Math.round(b / g) - 1, k.css("background-color", c.colors[0 > f ? 0 : f])), c.showHint && this._animate(l.html(Math.round(a)).css("left", d - l.width() / 2), {
                left: b - l.width() / 2
            })
        },
...
(function(c) {
    c.widget("metro.tabcontrol", {
        ...
        _create: function() {
            ...
            void 0 != b.data("effect") && (this.options.effect = b.data("effect"));
            this.init(d, e);
            b.on("click", ".tabs > li > a", function(d) {
                d.preventDefault();
                d.stopPropagation();
                a.options.tabclick(this);
                if (c(this).parent().hasClass("disabled")) return !1;
                b.children(".tabs").children("li").removeClass("active");
                b.children(".frames").children(".frame").hide();
                c(this).parent().addClass("active");
                d = c(c(this).attr("href"));
    ...
    c.widget("metro.times", {
        ...
        tick: function() {
            ...
            this._interval = setInterval(function() {
                ...
                b = b.getSeconds();
                a.updateDuo(4, 5, b);
                a.options.ontick(d, c, b);
                a.blinkDivider();
                var f = a.options.alarm;
                f && (void 0 != f.h && f.h == d && void 0 != f.m && f.m == c && void 0 != f.s && f.s == b) && (a.options.onalarm(), a._trigger("alarm"))
            }, 1E3)
        },
        blinkDivider: function() {
...
(function(c) {
    c.widget("metro.hint", {
        ...
        createHint: function() {
            ...
            void 0 != a.data("hintMode") && (d.mode = a.data("hintMode"));
            ...
            var e = 1 < b.length ? b[0] : !1,
                ...
                b = c("<div/>").appendTo("body");
            2 == d.mode ? b.addClass("hint2") :
                b.addClass("hint");
            ...
            "top" == d.position ? b.css({
                    ...
                    left: 2 == d.mode ? a.offset().left + a.outerWidth() / 2 - b.outerWidth() / 2 - c(window).scrollLeft() : a.offset().left - c(window).scrollLeft()
                }) : "bottom" ==
                d.position ? b.css({
                    ...
                    left: a.offset().left + a.outerWidth() + 15 - c(window).scrollLeft()
                }) : "left" == d.position && b.css({
                    top: 2 == d.mode ? a.offset().top + a.outerHeight() / 2 - b.outerHeight() /
                        2 - c(window).scrollTop() - 10 : a.offset().top - 10 - c(window).scrollTop(),
    ...
    c.widget("metro.scrollbar", {
        ...
        _resize: function() {
            ...
            if (!isNaN(parseInt(this.element.css("left"))) && 0 != parseInt(this.element.css("left")) || !isNaN(parseInt(this.element.css("top"))) &&
                ...
                var b = Math.abs(parseInt(this.element.css("left"))),
                    d = Math.abs(parseInt(this.element.css("top"))),
                    c = this.scrollbar.width(),
                    f = this.scrollbar.height();
                this.contentWidth - b < c && (b -= c - (this.contentWidth - b), 0 > b && (b = 0), this.element.css("left", -1 * b));
                this.element.css("left", -1 * b);
                this.contentHeight - d < f && (d -= f - (this.contentHeight - d), 0 > d && (d = 0), this.element.css("top", -1 * d))
            }
        ...
        _build: function(a,
            ...
            "y" == this.options.axis ? this.contentHeight > this.options.height ? (this.scrollbar.css({
                    paddingRight: 20,
                    paddingBottom: 0
                }), a = d.outerWidth(), b = d.outerHeight(), this.contentWidth =
                ...
                paddingBottom: 20,
                paddingRight: 0
            }), a = d.outerWidth(), b = d.outerHeight(), this.contentWidth = a, this.contentHeight = b), this._horizontalScrollbar(), this._startHandlers()) : (0 < this.scrollbar.find(".scrollbar-h").length &&
                this.scrollbar.find(".scrollbar-h").hide(), this.scrollbar.css({
                    ...
                    paddingRight: "+=5",
                    paddingBottom: "+=5"
                }), this.elemPadding = !0), a = d.outerWidth(), b = d.outerHeight(), this.contentWidth = a,
                ...
                paddingBottom: "-=5"
                    ...
                    paddingBottom: 20,
                    paddingRight: 0
                }), a = d.outerWidth(), b = d.outerHeight(), this.contentWidth = a, this.contentHeight =
                ...
                paddingRight: 20,
                paddingBottom: 0
            }), a = d.outerWidth(), b = d.outerHeight(), this.contentWidth = a, this.contentHeight = b, this._verticalScrollbar(), this._startHandlers()) : (0 < this.scrollbar.find(".scrollbar-v").length && this.scrollbar.find(".scrollbar-v").hide(),
                this.scrollbar.css({
                    paddingRight: 0,
                    paddingBottom: 0
                })))
        ...
        _verticalScrollbar: function() {
            ...
            var b = this.scrollbar.find(".scrollbar-line-v"),
                ...
                d = this.scrollbar.find(".scrollbar-v");
            if (this.bothScroll) {
                d.height(this.options.height);
                var c = d.height() - 15;
                this.options.height = c;
                d.height(c)
            } else d.height(this.options.height);
            d = this.options.height - 32;
            c = d / this.contentHeight;
            b.height(d);
            c >= (this.contentHeight - 32) / this.contentHeight ? a.hide() : (b = c * this.options.height, a.show().height(b))
        },
        _horizontalScrollbar: function() {
            ...
            var a = this.scrollbar.find(".scrollbar-line-h"),
                ...
                d = this.scrollbar.find(".scrollbar-h");
            if (this.bothScroll) {
                d.width(this.options.width);
                var c = d.width() - 15;
                this.options.width = c;
                d.width(c)
            } else d.width(this.options.width);
            var d = this.options.width - 32,
                c = d / this.contentWidth,
                f = c * this.options.width,
                g = isNaN(parseInt(this.element.css("left"))) ? 0 : parseInt(this.element.css("left")),
                g = Math.abs(g) * c;
            a.width(d);
            c >= (this.contentWidth - 32) / this.contentWidth ? b.hide() : b.show().width(f).css({
                left: g
            })
        },
        ...
        _fixScroll: function(a, b) {
            var d, c, f, g = this.options.wheel;
            ...
            } else h = 100 * (g / this.contentHeight), c = (this.options.height - 32) / 100 * h, h = parseInt(this.element.css("top")), f = isNaN(h) ? 0 : Math.abs(h), h = this.scrollbar.find(".scrollbar-line-v-btn"),
                d = this.scrollbar.find(".scrollbar-line-v"), k = parseFloat(h.css("top")), k = isNaN(k) ? 0 : k, 0 < a ? (g = f - g, c = k - c) : (g = f + g, c = k + c), 0 > g && (g = 0), g > this.contentHeight - this.options.height && (g = this.contentHeight - this.options.height), d.width(), f = d.height(), h.width(), d = h.height(), 0 > c && (c = 0), c + d > f && (c = f - d), this.element.css({
                    top: -1 * g
                }), h.css({
                    top: c
                })
...
(function(c) {
    c.widget("metro.stepper", {
        ...
        _createEvents: function() {
            var a = this.element,
                b = this.options;
            a.on("click", "li", function(d) {
                d = c(this).data("step");
                b.onStepClick(d - 1, d);
                a.trigger("stepclick", d)
            })
        },
        _createStepper: function() {
            var a = this.element,
                ...
                d, e;
            e = c("<ul/>");
            for (d = 0; d < b.steps; d++) c("<li/>").data("step", d + 1).appendTo(e);
            e.appendTo(a)
        },
    ...
    c.widget("metro.wizard", {
        ...
        _create: function() {
            var a = this,
                ...
                e = b.find(".step");
            this._steps = e;
            c.stepper && (this._stepper = this._createStepper(e.length).insertBefore(b.find(".steps")).stepper({
                clickable: c.stepperClickable
            }).on("stepclick", function(b, e) {
                a.stepTo(e);
                c.onStepClick(e)
            }));
            void 0 != b.data("locale") && (c.locale = b.data("locale"));
            this._createEvents();
            e = "default" != c.startPage && 1 < parseInt(c.startPage) ? c.startPage : 1;
            this.stepTo(e);
            this.options.onPage(this._currentStep + 1, b)
        },
        _createStepper: function(a) {
            var b = this.options;
            a = c("<div/>").addClass("stepper").attr("data-role",
                "stepper").attr("data-steps", a);
        ...
        _createEvents: function() {
            ...
            if (d.buttons) {
                var e = c("<div/>").addClass("actions").appendTo(b),
                    ...
                    g;
                d.buttons.cancel && (g = c("<button type='button'/>").addClass("btn-cancel").html(c.Metro.Locale[d.locale].buttons[2]), "boolean" == typeof d.buttons.cancel ? g.appendTo(f) : (d.buttons.cancel.title &&
                    g.html(d.buttons.cancel.title), d.buttons.cancel.cls && g.addClass(d.buttons.cancel.cls), d.buttons.cancel.group && "left" != d.buttons.cancel.group ? g.appendTo(e) : g.appendTo(f)), g.on("click", function() {
                    d.onCancel(a._currentStep + 1, b)
                }));
                d.buttons.help && (g = c("<button type='button'/>").addClass("btn-help").html(c.Metro.Locale[d.locale].buttons[3]), "boolean" == typeof d.buttons.help ? g.appendTo(e) : (d.buttons.help.title && g.html(d.buttons.help.title), d.buttons.help.cls && g.addClass(d.buttons.help.cls), d.buttons.help.group &&
                    "left" != d.buttons.help.group ? g.appendTo(e) : g.appendTo(f)), g.on("click", function() {
                    d.onHelp(a._currentStep + 1, b)
                }));
                d.buttons.prior && (g = c("<button type='button'/>").addClass("btn-prior").html(c.Metro.Locale[d.locale].buttons[4]), "boolean" == typeof d.buttons.prior ? g.appendTo(e) : (d.buttons.prior.title && g.html(d.buttons.prior.title), d.buttons.prior.cls && g.addClass(d.buttons.prior.cls), d.buttons.prior.group && "left" != d.buttons.prior.group ? g.appendTo(e) : g.appendTo(f)), g.on("click", function() {
                    d.onPrior(a._currentStep +
                        1, b) && a.prior()
                }));
                d.buttons.next && (g = c("<button type='button'/>").addClass("btn-next").html(c.Metro.Locale[d.locale].buttons[5]), "boolean" == typeof d.buttons.next ? g.appendTo(e) : (d.buttons.next.title && g.html(d.buttons.next.title), d.buttons.next.cls && g.addClass(d.buttons.next.cls), d.buttons.next.group && "left" != d.buttons.next.group ? g.appendTo(e) : g.appendTo(f)), g.on("click", function() {
                    d.onNext(a._currentStep + 1, b) && a.next()
                }));
                d.buttons.finish && (g = c("<button type='button'/>").addClass("btn-finish").html(c.Metro.Locale[d.locale].buttons[6]),
                    "boolean" == typeof d.buttons.finish ? g.appendTo(e) : (d.buttons.finish.title && g.html(d.buttons.finish.title), d.buttons.finish.cls && g.addClass(d.buttons.finish.cls), d.buttons.finish.group && "left" != d.buttons.finish.group ? g.appendTo(e) : g.appendTo(f)), g.on("click", function() {
        ...
        next: function() {
            ...
            void 0 !=
                this._stepper && this._stepper.stepper("stepTo", this._currentStep + 1);
            ...
            a == this._steps.length - 1 ? this.element.find(".btn-next").attr("disabled", !0) : this.element.find(".btn-next").attr("disabled", !1);
            0 < a && this.element.find(".btn-prior").attr("disabled", !1);
            return !0
        },
        prior: function() {
            ...
            var b = parseInt("default" == this.options.finishStep ? this._steps.length - 1 : this.options.finishStep);
            a == b ? this.element.find(".btn-finish").attr("disabled", !1) : this.element.find(".btn-finish").attr("disabled", !0);
            0 == a ? this.element.find(".btn-prior").attr("disabled", !0) : this.element.find(".btn-prior").attr("disabled", !1);
            a < b && this.element.find(".btn-next").attr("disabled", !1);
            return !0
        },
        stepTo: function(a) {
            var b = a - 1;
            ...
            this._currentStep = b;
            this._steps.hide();
            c(this._steps[b]).show();
            this.options.onPage(this._currentStep + 1, this.element);
            void 0 != this._stepper && this._stepper.stepper("stepTo", a);
            a = parseInt("default" == this.options.finishStep ? this._steps.length - 1 : this.options.finishStep);
            b == a ? this.element.find(".btn-finish").attr("disabled", !1) : this.element.find(".btn-finish").attr("disabled", !0);
            console.log(b,
                a);
            this.element.find(".btn-next").attr("disabled", !(b < a));
            this.element.find(".btn-prior").attr("disabled", !(0 < b));
            return !0
        },
        stepper: function() {
...
(function(c) {
    c.widget("metro.popover", {
        ...
        createPopover: function() {
            ...
            var e, f;
            e = c("<div/>").addClass("notice").appendTo("body").hide();
            c("<div/>").appendTo(e);
            d.popoverShadow &&
                e.addClass("shadow");
            d.popoverBackground && ("#" == d.popoverBackground[0] ? e.css("background-color", d.popoverBackground) : e.addClass(d.popoverBackground));
            d.popoverColor && ("#" == d.popoverColor[0] ? e.css("color", d.popoverColor) : e.addClass(d.popoverColor));
            switch (d.popoverPosition) {
                case "left":
                    f = "marker-on-right";
                    break;
                case "right":
            ...
            e.addClass(f);
            this.popover = e;
            this.setText(d.popoverText);
            b.on(d.popoverMode,
                function(b) {
                    e.data("visible") || a.show()
                });
        ...
        setPosition: function() {
            ...
            "top" == a.popoverPosition ? b.css({
                top: d.offset().top - c(window).scrollTop() - b.outerHeight() - 10,
                left: d.offset().left + d.outerWidth() / 2 - b.outerWidth() / 2 - c(window).scrollLeft()
            }) : "bottom" == a.popoverPosition ? b.css({
                top: d.offset().top - c(window).scrollTop() + d.outerHeight() + 10,
                left: d.offset().left + d.outerWidth() / 2 - b.outerWidth() /
                    2 - c(window).scrollLeft()
            }) : "right" == a.popoverPosition ? b.css({
                top: d.offset().top + d.outerHeight() / 2 - b.outerHeight() / 2 - c(window).scrollTop(),
                left: d.offset().left + d.outerWidth() - c(window).scrollLeft() + 10
            }) : "left" == a.popoverPosition && b.css({
                top: d.offset().top + d.outerHeight() / 2 - b.outerHeight() / 2 - c(window).scrollTop(),
                left: d.offset().left - b.outerWidth() - c(window).scrollLeft() - 10
            });
            return this
        },
        setText: function(a) {
...
(function(c) {
    ...
    c.Metro.initPopover = function(a) {
        void 0 != a && c(a).find("[data-popover=popover]").popover();
        c("[data-popover=popover]").popover()
    };
